...
- (void)startChat {
    UIViewController *vc = [ChartViewController1 new];
...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"聊天" style:UIBarButtonItemStylePlain target:self action:@selector(startChat)];
...
//    vc1.view.backgroundColor = [UIColor redColor];
    DogOwnerViewController *dogOwnerVC = [[DogOwnerViewController alloc] init];
    DogTypeGalleryViewController *dogTypeGalleryVC = [DogTypeGalleryViewController new];

    [self.mContainerVCArr addObject:dogOwnerVC];
    [self.mContainerVCArr addObject:dogTypeGalleryVC];
//    [self.mContainerVCArr addObject:vc];
...
- (NSArray<UIImage *> *)tabBarImages {
    return @[[UIImage imageNamed:@"dog_50x50_b"],
//             [UIImage imageNamed:@"down_button"],
             [UIImage imageNamed:@"dog_50x50_p"]
             ];
}

- (UIColor *)tabBarColor {
    return [UIColor colorWithRed:0x90/255.f green:0x4e/255.f blue:0x1d/255.f alpha:1.0f];
}
...
- (void)setupNavigationStyle {
    NavigationTheme *theme = [[NavigationTheme alloc]
                              ...
                              //bar color
                              barColor:[UIColor colorWithRed:0x90/255.f green:0x4e/255.f blue:0x1d/255.f alpha:1.0f]
                              //title font, size
...
- (void)setupUI {
    self.homeButton = [self createTabButtonWithTitle:@"首页"];
    [self.homeButton setImage:[UIImage imageNamed:@"dog_50x50_h"] forState:UIControlStateNormal];
